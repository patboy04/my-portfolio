...
const About = () => {
  return (
    <div name='about' className='w-full min-h-screen bg-white flex flex-col justify-center lg:flex-row '>
        ...
        <div className='lg:py-20 lg:pt-40 lg:text-3xl lg:my-32'>
            ...
            <p className='text-base p-1 pb-10 text-center text-[#059669] md:text-xl md:mx-20 lg:text-xl '>Hi! I'm John Patrick Lacsamana, A Computer Science Graduate from the University 
